...
# SCPN ICF Laser Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_icf_laser_core/__init__.py",
    "src/scpn_icf_laser_core/configuration.py",
    "src/scpn_icf_laser_core/errors.py",
    "src/scpn_icf_laser_core/observability.py",
    "src/scpn_icf_laser_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_icf_laser_core/parameters.py",
    "docs/DEVICE_3D_MODEL_CONTRACT.md",
    "docs/adr/0006-device-3d-and-cad-models.md",
    "src/scpn_icf_laser_core/geometry/__init__.py",
    "src/scpn_icf_laser_core/geometry/device.py",
    "src/scpn_icf_laser_core/geometry/model.py",
    "src/scpn_icf_laser_core/geometry/cad.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-ICF-LASER-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_icf_laser_core import OWNED_CONFIGURATIONS, RegistryBinding
...
def test_typed_package_marker_exists() -> None:
    ...
    assert (REPO / "src" / "scpn_icf_laser_core" / "py.typed").is_file()
