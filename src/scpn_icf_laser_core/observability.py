...
# SCPN ICF Laser Core — diagnostic and clock semantics
...
identities for the laser inertial-confinement configurations this
...
from scpn_icf_laser_core.configuration import ConsistencyFinding
from scpn_icf_laser_core.errors import DiagnosticPlanError
...
DRIVER_TIMING_CEILING_S: Final = 1.0e-10
        ...
        for configuration in self.configurations:
            if configuration not in OWNED_CONFIGURATIONS:
                raise DiagnosticPlanError(
                    ...
                    f"{configuration!r} is not owned by SCPN-ICF-LASER-CORE"
                )
    ...
    def __post_init__(self) -> None:
        ...
        if self.candidate_id not in _CANDIDATE_INDEX:
            raise DiagnosticPlanError(
                ...
                "applicable to SCPN-ICF-LASER-CORE"
            )
        if not self.reason:
...
class DiagnosticPlan:
    ...
    def consistency_report(self) -> tuple[ConsistencyFinding, ...]:
        ...
        tuple of ConsistencyFinding
            Findings from documented laser-ICF diagnostic practice; empty
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            ...
                            " is coarser than the tens-of-ps "
                            "beam-timing precision of laser drivers "
                            "(Lindl 1995)"
                        ),
                    )
                )
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            ...
                            "longer than the laser-ICF shot scale of up to ~1 "
                            "us (Lindl 1995)"
                        ),
                    )
                )
