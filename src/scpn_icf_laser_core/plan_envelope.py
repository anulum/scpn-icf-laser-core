...
# SCPN ICF Laser Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-ICF-LASER-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_icf_laser_core.observability.CATALOGUE_BINDING`.
    plan_identifier
