...
SCPN ICF Laser Core — GOVERNANCE
-->
...
The project boundary — the assignment of `laser_icf_direct_drive` and
`laser_icf_fast_or_shock_ignition` and
`laser_icf_indirect_drive` to this repository, and the exclusions listed in the
