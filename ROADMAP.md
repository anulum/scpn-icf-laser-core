...
- **Diagnostic and clock semantics** (landed 2026-08-31) — synthetic
  ...
  (beam-timing train, trajectory radiography, asymmetry mode set, shot-outcome set, synthetic oscillator); `computational_prototype` (ADR 0003,
...
Ion-beam and electron-beam ICF, projectile/impact ICF, MagLIF, magnetic
confinement systems, generic controller mathematics, machine-protection
